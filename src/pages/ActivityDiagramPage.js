...
// Mock data for activity diagrams
const activityDiagramsData = [
  {
    id: '1',
    title: 'User Registration Process',
    description: 'Activity diagram showing the user registration and verification process',
    url: 'https://ucarecdn.com/85ac3de7-1fd4-433c-9cc2-105c192b1a01/',
    handle: '85ac3de7-1fd4-433c-9cc2-105c192b1a01',
    filename: 'user_registration_activity.drawio',
    mimetype: 'application/octet-stream',
    seq: 1,
    project: '5fb513797d8f3d66d8da982e',
    rating: 4,
    comment: 'Well-structured diagram with clear flow and decision points.',
    reviewed: true,
    requirementsLinked: [
      { id: '10', text: 'The system must support user registration with email verification.' },
      { id: '11', text: 'Users must be able to create an account using email or social login.' }
    ]
  },
  {
    id: '2',
    title: 'Activity Tracking Workflow',
    description: 'Activity diagram showing the process of tracking and recording user activities',
    url: 'https://ucarecdn.com/76bc4de9-2fd4-453c-9bb2-115d194b1c02/',
    handle: '76bc4de9-2fd4-453c-9bb2-115d194b1c02',
    filename: 'activity_tracking_workflow.drawio',
    mimetype: 'application/octet-stream',
    seq: 2,
    project: '5fb513797d8f3d66d8da982e',
    rating: 0,
    ...
    requirementsLinked: [
      ...
      { id: '20', text: 'The system must store historical activity data for user analysis.' }
    ]
  }
];

// Rubric data
const activityDiagramRubric = [
  { name: 'Flow Logic', description: 'Correctly shows the flow of activities', score: 4 },
  { name: 'Decision Points', description: 'Properly represents decision points and conditions', score: 3 },
  { name: 'Parallel Activities', description: 'Correctly shows concurrent activities', score: 3 },
  { name: 'Start/End Points', description: 'Clear entry and exit points', score: 5 },
  { name: 'Clarity', description: 'Easy to follow and understand', score: 4 }
];

const ActivityDiagramsPage = () => {
  const { projectId } = useParams();
  const [activityDiagrams, setActivityDiagrams] = useState([]);
  ...
  useEffect(() => {
    ...
    setActivityDiagrams(activityDiagramsData);
  }, [projectId]);
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto p-4">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Activity Diagrams Review</h1>
        </div>
        ...
        {showRubric && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold mb-4">Activity Diagrams Rubric Evaluation</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              {activityDiagramRubric.map((criteria, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between mb-2">
                    <h3 className="font-semibold">{criteria.name}</h3>
                    <StarRating value={criteria.score} onChange={(newValue) => {
                      const updatedRubric = [...activityDiagramRubric];
            ...
            <div className="flex justify-between items-center bg-indigo-50 border border-indigo-200 rounded-lg p-4">
              <div>
                <span className="text-indigo-700 font-semibold">Overall Rubric Score:</span>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <textarea 
            ...
            placeholder="Add general comments about all activity diagrams..."
            rows="4"
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold mb-4">Activity Diagrams</h2>
          
          <div className="space-y-6">
            {activityDiagrams.map(diagram => (
              <div key={diagram.id} className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="h-64 bg-gray-100 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    <div className="mb-2">Activity Diagram Preview</div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl w-full max-h-screen overflow-y-auto">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-xl font-bold">Review Activity Diagram: {selectedDiagram.title}</h2>
                <button 
              ...
              <div className="mb-6">
                ...
                <div className="h-96 bg-gray-100 flex items-center justify-center border border-gray-200 rounded">
                  <div className="text-center text-gray-500">
                    <div className="text-xl mb-2">Activity Diagram Preview</div>
              ...
              <div className="mb-6">
                ...
                <textarea 
                  ...
                  placeholder="Add your comments about this activity diagram..."
                ></textarea>
              </div>
