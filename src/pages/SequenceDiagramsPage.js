...
// Mock data for sequence diagrams
const sequenceDiagramsData = [
  {
    id: '1',
    title: 'User Login Sequence',
    description: 'Sequence diagram showing the login process flow between user, UI, and backend services',
    url: 'https://ucarecdn.com/01ee952c-d515-4e1e-937c-590fbd675934/',
    handle: '01ee952c-d515-4e1e-937c-590fbd675934',
    filename: 'login_sequence.drawio',
    mimetype: 'application/octet-stream',
    seq: 1,
    project: '5fb513797d8f3d66d8da982e',
    rating: 4,
    comment: 'Clear sequence with good representation of asynchronous operations.',
    reviewed: true,
    storiesLinked: [
  ...
  {
    id: '2',
    title: 'Activity Recording Process',
    description: 'Sequence diagram showing the interactions between app components when recording a new activity',
    url: 'https://ucarecdn.com/7c6d4053-8ec8-3b65-da35-108406d9cab9/',
    handle: '7c6d4053-8ec8-3b65-da35-108406d9cab9',
    filename: 'activity_record_sequence.drawio',
    mimetype: 'application/octet-stream',
    seq: 2,
    project: '5fb513797d8f3d66d8da982e',
    rating: 0,
...
// Rubric data
const sequenceDiagramRubric = [
  { name: 'Object Interaction', description: 'Correctly shows interaction between objects', score: 4 },
  { name: 'Message Flow', description: 'Proper sequence of messages', score: 4 },
  { name: 'Return Values', description: 'Properly shows return values and responses', score: 3 },
  { name: 'Exception Handling', description: 'Includes error scenarios', score: 2 },
  { name: 'Completeness', description: 'Covers all necessary interactions', score: 4 }
];

const SequenceDiagramsPage = () => {
  const { projectId } = useParams();
  const [sequenceDiagrams, setSequenceDiagrams] = useState([]);
  ...
  useEffect(() => {
    ...
    setSequenceDiagrams(sequenceDiagramsData);
  }, [projectId]);
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto p-4">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Sequence Diagrams Review</h1>
        </div>
        ...
        {showRubric && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold mb-4">Sequence Diagrams Rubric Evaluation</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              {sequenceDiagramRubric.map((criteria, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between mb-2">
                    <h3 className="font-semibold">{criteria.name}</h3>
                    <StarRating value={criteria.score} onChange={(newValue) => {
                      const updatedRubric = [...sequenceDiagramRubric];
            ...
            <div className="flex justify-between items-center bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div>
                <span className="text-yellow-700 font-semibold">Overall Rubric Score:</span>
                <span className="text-xl font-bold ml-2">3.4/5</span>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <textarea 
            ...
            placeholder="Add general comments about all sequence diagrams..."
            rows="4"
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold mb-4">Sequence Diagrams</h2>
              ...
              <div key={diagram.id} className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="h-64 bg-gray-100 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    <div className="mb-2">Sequence Diagram Preview</div>
                    <p className="text-sm">Filename: {diagram.filename}</p>
                  </div>
                </div>
                
                {diagram.storiesLinked && diagram.storiesLinked.length > 0 && (
                  <div className="p-4 border-t border-gray-200">
                    <h4 className="font-medium text-sm mb-2">Linked Stories:</h4>
                    <div className="space-y-1">
                      {diagram.storiesLinked.map(story => (
                        <div key={story.id} className="bg-green-50 p-2 rounded text-sm">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl w-full max-h-screen overflow-y-auto">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-xl font-bold">Review Sequence Diagram: {selectedDiagram.title}</h2>
                <button 
              ...
              <div className="mb-6">
                ...
                <div className="h-96 bg-gray-100 flex items-center justify-center border border-gray-200 rounded">
                  <div className="text-center text-gray-500">
                    <div className="text-xl mb-2">Sequence Diagram Preview</div>
              ...
              {selectedDiagram.storiesLinked && selectedDiagram.storiesLinked.length > 0 && (
                <div className="mb-6">
                  <h3 className="font-semibold mb-2">Linked Stories</h3>
                  <div className="space-y-2">
                    {selectedDiagram.storiesLinked.map(story => (
              ...
              <div className="mb-6">
                ...
                <textarea 
                  ...
                  placeholder="Add your comments about this sequence diagram..."
                ></textarea>
              </div>
