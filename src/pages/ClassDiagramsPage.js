...
const classDiagramsData = [
  {
    id: '1',
    title: 'User Management',
    description: 'Class diagram showing the user domain model including authentication and profile management',
    url: 'https://ucarecdn.com/5bf23776-7296-479c-8f5c-a7a33ed0b187/',
    handle: '5bf23776-7296-479c-8f5c-a7a33ed0b187',
    filename: 'user_class_diagram.drawio',
    mimetype: 'application/octet-stream',
    seq: 2,
    project: '5fb513797d8f3d66d8da982e',
    rating: 4,
    comment: 'Well structured class hierarchy with appropriate relationships.',
    reviewed: true,
    requirementsLinked: [
  ...
  },
  {
    ...
    description: 'Class diagram showing the activity tracking domain model',
    url: 'https://ucarecdn.com/85b231aa-0355-4e45-8be2-e0bfd2d4d265/',
    handle: '85b231aa-0355-4e45-8be2-e0bfd2d4d265',
    filename: 'activity_class_diagram.drawio',
    mimetype: 'application/octet-stream',
    seq: 4,
    project: '5fb513797d8f3d66d8da982e',
    rating: 0,
...
// Rubric data
const classDiagramRubric = [
  { name: 'Class Structure', description: 'Appropriate use of classes, attributes, methods', score: 3 },
  { name: 'Relationship Modeling', description: 'Appropriate associations, inheritance, composition', score: 4 },
  { name: 'Completeness', description: 'Covers all required functionality', score: 3 },
  { name: 'Clarity', description: 'Naming and organization are clear and consistent', score: 2 },
  { name: 'Design Principles', description: 'Follows OOP principles (encapsulation, etc.)', score: 4 }
];
...
const ClassDiagramsPage = () => {
  ...
  const [classDiagrams, setClassDiagrams] = useState([]);
  ...
  useEffect(() => {
    ...
    setClassDiagrams(classDiagramsData);
  }, [projectId]);
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto p-4">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Class Diagrams Review</h1>
        </div>
        ...
        {showRubric && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-bold mb-4">Class Diagrams Rubric Evaluation</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              {classDiagramRubric.map((criteria, index) => (
            ...
            <div className="flex justify-between items-center bg-purple-50 border border-purple-200 rounded-lg p-4">
              <div>
                <span className="text-purple-700 font-semibold">Overall Rubric Score:</span>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <textarea 
            ...
            placeholder="Add general comments about all class diagrams..."
            rows="4"
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold mb-4">Class Diagrams</h2>
              ...
              <div key={diagram.id} className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="h-64 bg-gray-100 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    <div className="mb-2">Diagram Preview</div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl w-full max-h-screen overflow-y-auto">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-xl font-bold">Review Class Diagram: {selectedDiagram.title}</h2>
                <button 
              ...
              <div className="mb-6">
                ...
                <div className="h-96 bg-gray-100 flex items-center justify-center border border-gray-200 rounded">
                  <div className="text-center text-gray-500">
                    <div className="text-xl mb-2">Class Diagram Preview</div>
              ...
              <div className="mb-6">
                ...
                <textarea 
                  ...
                  placeholder="Add your comments about this class diagram..."
                ></textarea>
              </div>
